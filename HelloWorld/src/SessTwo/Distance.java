...
public class Distance {
    public static void main (String [] args) {
        ...
        System.out.println("d square is " + square(x1, y1, x2, y2));
        System.out.println("d square root is " + squareRoot(x1, y1, x2, y2));
        System.out.println("Area of PI 3^2 is " + calculateArea(3));
